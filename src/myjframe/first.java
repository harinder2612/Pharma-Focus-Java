...
public class first extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/myjframe/PF_logo_300x400.png"))); // NOI18N

        label1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/myjframe/aaa.png"))); // NOI18N
        label1.setText(" ");

        cbuser.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        cbuser.setForeground(new java.awt.Color(0, 0, 153));
        cbuser.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ADMIN", "CUSTOMER", "SELLER" }));
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/myjframe/red-medical-logo-5ud5DA-clipart.jpeg"))); // NOI18N
        jLabel4.setText("Online Medical Selling and Purchasing Store");
        ...
        jLabel1.setText(" Pharma Focus is an application which acts as bridge between Seller and Customer. ");
...
String check;  
      check= cbuser.getSelectedItem().toString();
      System.out.println(check);
        dispose();
        new loginframe(check).setVisible(true);
